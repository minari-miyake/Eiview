                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ $recentReviews->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ isset($favoriteMovies) ? $favoriteMovies->count() : 0 }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">
                                    @if($recentReviews->count() > 0)
                                        {{ number_format($recentReviews->avg('rating'), 1) }}
                                    @else
                                        -価
                                    @endif
                                </p>
